...
<body>
    ...
    <form action="process.php" method="post" onsubmit="return validation()">
        ...
        <input type="tel" class="form-control" placeholder="Phone Number" id="phone" style="width: 100%" name="phone">
        </div>
        ...
        <div class="form-group">
            <select class="form-control" id="exampleFormControlSelect1" name="country">
              ...
              <option value="Falkland Islands">Falkland Islands (Malvins)</option>
